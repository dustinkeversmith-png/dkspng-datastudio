...
from backend.metadata_finder import discover_metadata, fetch_metadata, DocumentRegistry
from backend.metadata_finder.adapter import OfficialMetaAdapter
...
from backend.examples.three_portal_bindings import register_three_portal_sources
