...
from backend.modules.sources.source_registry import get_source
...
class Source:
    ...
    def add_source(self, key_or_def: str | SourceDefinition) -> "Source":
        from backend.modules.data.connectors.factory import create_connector
        if isinstance(key_or_def, str):
    ...
    def generate_metadata(self) -> "Source":
        from backend.modules.sources.column_info.analyzer.analyzer import MetadataAnalyzer
    ...
    def __getitem__(self, source_key: str) -> "SourceProxy":
        from backend.modules.data.expressions.axis_expr import SourceProxy
    ...
    def index(self, **queries) -> "Source":
        ...
        """
        from backend.modules.data.indexing.index_parser import parse_row_index, parse_col_index
    ...
    def map(self, name: str, index: str | int = "all") -> "Column":
        ...
        """
        from backend.modules.data.indexing.index_parser import parse_row_index
        from backend.modules.data.mappings.column import Column
    ...
    def append(self, column: "Column", target: Set[str] | tuple) -> "Source":
        ...
        """
        from backend.modules.data.mappings.column import Column as ColType
    ...
    def find_matching_types(self, sources: Set[str], types: Set[str]) -> Dict[str, List[str]]:
        ...
        from backend.operations.data_ops import check_base_types
    ...
    def add(
        ...
        from backend.modules.data.mappings.column import Column
        from backend.modules.data.expressions.expr_parser import eval_expression
    ...
    def log_regression(
        ...
        from backend.modules.analysis.models.regression.linear_regression_model import RegressionResult
    ...
    def knn(
        ...
        from backend.modules.analysis.models.clustering.spatial_temporal_model import KNNResult
    ...
    def bar(self, x_expr: "AxisExpr", y_expr: "AxisExpr") -> "Chart":
        from backend.modules.visualization.charts.chart import Chart
