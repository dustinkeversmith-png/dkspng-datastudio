...
CENTRE_LAT = EUGENE_LAT
CENTRE_LON = EUGENE_LON
QUERY_RADIUS_MI = 50
PLOT_DIR = os.path.join("data", "plots", "eugene")
        ...
        try:
            ...
            if lat_col and lon_col:
                filtered = _filter_by_distance(df, lat_col, lon_col,
                                               CENTRE_LAT, CENTRE_LON, QUERY_RADIUS_MI)
            else:
                filtered = df
...
def project2() -> None:
    ...
    print(f"Centre: Eugene, OR  ({CENTRE_LAT}, {CENTRE_LON})")
